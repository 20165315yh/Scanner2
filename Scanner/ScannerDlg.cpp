...
CScannerDlg::CScannerDlg(CWnd* pParent /*=nullptr*/)
...
BOOL CScannerDlg::OnInitDialog()
{
	...
	//添加标签页
	m_TabMain.AddPage(TEXT("主机扫描"), &hScan, IDD_DIALOGHOSTSCAN);
	m_TabMain.AddPage(TEXT("端口扫描之TCP扫描"), &pScan, IDD_DIALOGPORTSCAN);
	m_TabMain.AddPage(TEXT("端口扫描之SYN扫描"), &yScan, IDD_DIALOGSYNSCAN);
	m_TabMain.AddPage(TEXT("SQL注入扫描"), &sScan, IDD_DIALOGSQLSCAN);
